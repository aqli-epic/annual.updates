...
# South East Asia figure 3.2 ============
# southeast asia figure 3.2 data
ar_se_asia_fig3.2_data <- gadm0_aqli_2022 %>% 
  filter(country %in% c("Malaysia","Indonesia")) %>% 
  select(country, pm2022,pm2019) %>%
  group_by(country)
...
ar_appendix_table <- gadm0_aqli_2022 %>%
  ...
  mutate(llpp_nat_2022 = ifelse(pm2022>natstandard.y, 0.098*(pm2022-natstandard.y), NA)) %>%
  ...
  select(country, pm2022, natstandard.y, llpp_who_2022, llpp_nat_2022) %>%
  ...
  rename(Country = country, 
         ...
         "National Standard (in µg/m³)" = natstandard.y, 
