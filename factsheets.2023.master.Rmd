...
india_fs_fig1 <- india_fs_fig1_data %>%
  ...
  geom_sf(data = india_state, color = "black", fill = "transparent", lwd = 1.05) +
  ggthemes::theme_map() + 
 scale_fill_manual(values = c("0 - < 0.1 years" = "#FFFFFF", 
                               ...
                               ">= 6" = "#8C130E")) +
  ggthemes::theme_map() +
  labs(fill = "Life years lost  ", title = expression("Potential Gains in Life Expectancy (India) through Permanently Reducing" ~ PM[2.5] ~ "from 2021 concentrations to the WHO guideline")) + 
