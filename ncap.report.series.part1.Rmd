...
color_2021 <- read_csv("./september.2023/master.dataset/[june302023]gadm2_aqli_2021_internal_col_names.csv")
...
colormap_shp_2021 <- st_read("./september.2023/master.dataset/shapefiles/june302023_post_missing_data_incorp_nat_stan_adj/aqli_gadm2_final_june302023.shp")
...
foo1 <- color_2021 %>%
  ...
  summarise(avg_pm2017_pop_red = sum(pm2017_pop_weighted_red, na.rm = TRUE), 
            avg_pm2017_pop = sum(pm2017_pop_weighted, na.rm = TRUE))
