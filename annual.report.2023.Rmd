...
plt_top10_most_populous_tot_person_years_gained <- ar_fig3_dataset %>%
  ggplot() +
  geom_col(mapping = aes(x = forcats::fct_reorder(country, total_lyl_who_2021_millions), y = total_lyl_who_2021_millions, fill = country), width = 0.7) +
...
ar_prelim_fig5_dataset$region <- factor(ar_prelim_fig5_dataset$region, levels = c("South Asia", "China", "Rest of the World", "Global"))
