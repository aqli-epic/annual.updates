...
color_data <- read_csv("./data-raw/raw_files_all/2020_update_peru/color.csv")

color_data$country <- str_to_lower(color_data$country)
color_data$name_1 <- str_to_lower(color_data$name_1)
color_data$name_2 <- str_to_lower(color_data$name_2)

color_data_cen_west_africa <- color_data %>%
