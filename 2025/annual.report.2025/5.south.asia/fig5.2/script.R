...
gbd_results_sa_fig5.2 <- gbd_results_master_2025 %>%
...
gbd_results_sa_fig5.2$country <- factor(gbd_results_sa_fig5.2$country, 
                                        levels = c("Bangladesh", "Nepal", "India", "Pakistan"))


# Converting 'cause_of_death' to type factor
gbd_results_sa_fig5.2$cause_of_death <- as.factor(gbd_results_sa_fig5.2$cause_of_death)

# Rearranging 'cause of death' levels
levels(gbd_results_sa_fig5.2$cause_of_death) <- c("Child and maternal malnutrition", 
                                                  "Dietary risks", 
                                                  "PM2.5 relative to WHO guideline", 
                                                  "Tobacco",
                                                  "Unsafe water, sanitation, and handwashing")
...
levels(gbd_results_sa_fig5.2$cause_of_death) <- str_wrap(levels(gbd_results_sa_fig5.2$cause_of_death), 30)
...
gbd_results_sa_fig5.2 <- gbd_results_sa_fig5.2 %>% 
...
# plot 
ar_south_asia_fig5.2 <- gbd_results_sa_fig5.2 %>%
