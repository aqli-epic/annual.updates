...
# Central and West Africa figure 8.2 ============
gbd_results_cwafrica_fig8.2 <- gbd_results_master_2023 %>%
...
gbd_results_cwafrica_fig8.2$country <- factor(gbd_results_cwafrica_fig8.2$country,
                                              levels = c("Nigeria",
                                                         "Democratic Republic of the Congo",
                                                         "Ghana",
                                                         "Cameroon"))
...
gbd_results_cwafrica_fig8.2$country <-  str_replace(gbd_results_cwafrica_fig8.2$country,
                                                    "Democratic Republic of the Congo", "DR Congo")

# Converting 'cause_of_death' to type factor
gbd_results_cwafrica_fig8.2$cause_of_death <- as.factor(gbd_results_cwafrica_fig8.2$cause_of_death)

# Rearranging 'cause of death' levels
levels(gbd_results_cwafrica_fig8.2$cause_of_death) <- c("HIV/AIDS and sexually transmitted infections",
                                                        "Neglected tropical diseases and malaria",
                                                        "PM2.5 relative to WHO guideline",
                                                        "Unsafe water, sanitation, and handwashing")

# wrapping x-axis labels text
levels(gbd_results_cwafrica_fig8.2$cause_of_death) <- str_wrap(levels(gbd_results_cwafrica_fig8.2$cause_of_death), 30)

# reorder within each location as per the total life years lost column
gbd_results_cwafrica_fig8.2 <- gbd_results_cwafrica_fig8.2 %>%
...
# plot
ar_cw_africa_fig8.2 <- gbd_results_cwafrica_fig8.2 %>%
