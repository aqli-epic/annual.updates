...
# Figure 2: Potential gain in life expectancy from reducing PM2.5 from 2023 levels to the WHO guideline in 10 most populous provinces of cameroon

cam_fs_fig2_dataset <- gadm2_aqli_2023 %>%
...
# cam fs figure 2
cam_fs_fig2 <- cam_fs_fig2_dataset %>%
  ggplot() +
