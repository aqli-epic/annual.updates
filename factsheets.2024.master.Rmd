...
appendix_table_raw_india <- gadm_level_summary(gadm2_aqli_2022, c("country", "name_1"), c(2022), 10) %>%
  ...
  write_csv("july.2024/factsheets/india/[08Mar2024]india_fs_2024_appendix_table.csv")
```
...
gadm2_aqli_2022 %>%
  ...
  write_csv("july.2024/factsheets/bangladesh/[08Mar2024]bangladesh_fs_2024_appendix_table.csv")
...
# Fig 1: Potential gain in life expectancy from permanently reducing PM ------
...
pak_fs_appendix_table <- pak_aqli_2022 %>%
  ...
  write_csv("july.2024/factsheets/pakistan//[11Mar2024]pakistan_fs_2024_appendix_table.csv")
```
