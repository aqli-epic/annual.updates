...
# [Not included in campaign, will probably use later]: Figure 5: generate a life years lost graph grouped by population, for India as a whole, Rural India and Urban India 
```{r}
...
# Figure 5: Pollution in top 5 most polluted districts not touched by NCAP
```{r}
