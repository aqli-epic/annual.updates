...
# data
nigeria_fs_fig1_data <- gadm2_aqli_2023 %>%
...
# nigeria factsheet figure 1- global
nigeria_fs_fig1 <- nigeria_fs_fig1_data %>%
  ...
  geom_sf(data = gadm1_aqli_2023_shp %>% filter(name0 == "Nigeria"), color = "azure4", fill = "transparent", lwd = 0.1) +
  geom_sf(data = gadm0_aqli_2023_shp %>% filter(name0 == "Nigeria"), color = "cornsilk4", fill = "transparent", lwd = 0.3) +
