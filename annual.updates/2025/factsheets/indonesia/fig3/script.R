...
#Figure 3: Annual average PM2.5 concentrations in Indonesia, 1998-2023

# indonesia factsheet figure 3 dataset
indonesia_fs_fig3_dataset <- gadm2_aqli_2023 %>%
...
indonesia_fs_fig3 <- indonesia_fs_fig3_dataset %>%
  ...
  geom_text(x = 2003.5, y = 5.6, label = expression("WHO" ~ PM[2.5] ~ "Guideline (last updated: 2021): 5 µg/m³"), size = 6.5) +
  geom_text(x = 2003.6, y = 15.6, label = expression("Indonesia National" ~ PM[2.5] ~ "Standard: 15 µg/m³"), size = 6.5)
