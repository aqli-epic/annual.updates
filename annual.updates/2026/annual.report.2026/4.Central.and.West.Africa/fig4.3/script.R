...
# Figure 4.3: Annual average PM2.5 concentrations in CWA
CWA_fs_fig_dataset <- gadm2_aqli_2024 %>%
  filter(country %in% central_and_west_african_countries, !is.na(population)) %>%
