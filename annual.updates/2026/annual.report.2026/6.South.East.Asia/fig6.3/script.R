...
# Figure 4: Annual average PM2.5 concentrations in se_asia, including 5 countries
se_asia_fig_dataset <- gadm2_aqli_2024 %>%
  filter(country %in% se_asia_vec, !is.na(population)) %>%
...
# se_asia figure 4
se_asia_fs_fig <- se_asia_fs_fig_dataset %>%
  ggplot() +
