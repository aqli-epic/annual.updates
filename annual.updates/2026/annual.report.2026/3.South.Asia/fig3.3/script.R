...
# Figure 4: Annual average PM2.5 concentrations in south_asia, including 5 countries
south_asia_fs_fig_dataset <- gadm2_aqli_2024 %>%
  filter(country %in% south_asia_def, !is.na(population)) %>%
...
# south_asia factsheet figure 4
south_asia_fs_fig <- south_asia_fs_fig_dataset %>%
  ggplot() +
