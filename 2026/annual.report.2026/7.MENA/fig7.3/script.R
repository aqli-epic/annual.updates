...
# Figure 4: Annual average PM2.5 concentrations in MENA, including 5 countries
MENA_fs_fig_dataset <- gadm2_aqli_2024 %>%
  filter(country %in% mena_countries, !is.na(population)) %>%
...
# MENA factsheet figure 4
MENA_fs_fig <- MENA_fs_fig_dataset %>%
  ggplot() +
