...
# read shapefiles and filter for guatemala
...
aqli_2021_gadm1 <- read.csv(glue("{dir}/[June302023]aqli_internal_col_names_CSVs/[june302023]gadm1_aqli_2021_internal_col_names.csv")) %>%
  filter(country == "Guatemala")
aqli_2021_gadm0 <- read.csv(glue("{dir}/[June302023]aqli_internal_col_names_CSVs/[june302023]gadm0_aqli_2021_internal_col_names.csv"))

# read and filter gbd results for guatemala
gbd_results_guatemala <- read.csv(glue("{dir}/gbd_results_master.csv")) %>%
  filter(country == "Guatemala")

# guatemala fs fig 1 data
guatemala_fs_fig1_dataset <- aqli_2021 %>%
...
# save guatemala fs figure 1
ggsave(glue("{dir}/guatemala/output/guatemala_fs_fig1.png"), height = 10, width = 15, guatemala_fs_fig1)

svglite("guatemala_fs_fig1")
ggsave(glue("{dir}/guatemala/output/guatemala_fs_fig1.svg"), height = 10, width = 15, dpi = 300, guatemala_fs_fig1)

# guatemala fs fig 2 data
guatemala_fs_fig2_dataset <- aqli_2021 %>%
...
# save figure 2 data
# guatemala_fs_fig2_dataset %>% write_csv(glue("{dir}/guatemala/output/guatemala_fs_fig2_dataset.csv"))
...
# save guatemala fs figure 2
ggsave(glue("{dir}/guatemala/output/guatemala_fs_fig2.png"), height = 9, width = 12, guatemala_fs_fig2)

svglite("guatemala_fs_fig2")
ggsave(glue("{dir}/guatemala/output/guatemala_fs_fig2.svg"), height = 9, width = 12, dpi = 300, guatemala_fs_fig2)
...
# save figure 3 data
# guatemala_fs_fig3_dataset %>% write_csv(glue("{dir}/guatemala/output/guatemala_fs_fig3_dataset.csv"))
...
# save guatemala fs figure 3
ggsave(glue("{dir}/guatemala/output/guatemala_fs_fig3.png"), height = 9, width = 15, guatemala_fs_fig3)

svglite("guatemala_fs_fig3")
ggsave(glue("{dir}/guatemala/output/guatemala_fs_fig3.svg"), height = 9, width = 15, dpi = 300, guatemala_fs_fig3)

# guatemala factsheet figure 4 dataset
guatemala_fs_fig4_dataset <- aqli_2021 %>%
  mutate(pop_weights = population/sum(population, na.rm = TRUE),
...
# save figure 4 data
# guatemala_fs_fig4_dataset %>% write_csv(glue("{dir}/guatemala/output/guatemala_fs_fig4_dataset.csv"))
...
# save guatemala fs figure 4
ggsave(glue("{dir}/guatemala/output/guatemala_fs_fig4.png"), height = 9, width = 15, guatemala_fs_fig4)

svglite("guatemala_fs_fig4")
ggsave(glue("{dir}/guatemala/output/guatemala_fs_fig4.svg"), height = 9, width = 15, dpi = 300, guatemala_fs_fig4)

# guatemala factsheet appendix table 
guatemala_fs_appendix_table <- aqli_2021 %>%
...
# save guatemala factsheet appendix table
guatemala_fs_appendix_table %>% write_csv(glue("{dir}/guatemala/output/guatemala_fs_appendix_table.csv"))
